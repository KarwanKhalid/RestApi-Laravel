...
#    git checkout 5.2
    ...
    php -r "
        ...
        \$arr[\"autoload\"][\"psr-4\"][\"KarwanKhalid\\\\RestAPI\\\\\"] = \"laravel-rest-api/src\";
        \$arr[\"autoload\"][\"psr-4\"][\"KarwanKhalid\\\\RestAPI\\\\Tests\\\\\"] = \"laravel-rest-api/tests\";
...
git clone https://github.com/KarwanKhalid/laravel-rest-api
git checkout master
composer du
cd .. || exit